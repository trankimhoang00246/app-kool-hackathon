...
import 'package:kool/choose_mi_screen.dart';
  ...
  Future<void> registerUser() async {
    try {
      final response = await http.post(
        Uri.parse('http://$serverIp:8080/register'),
          ...
          const Positioned(
            ...
            child: Text(
              ...
              style: TextStyle(
                  color: Colors.black,
                  fontWeight: FontWeight.normal,
                  fontSize: 13.0, // giá trị kích thước phông chữ là 15px
                  fontFamily: 'Poppins'),
            ),
          ),
          Positioned(
